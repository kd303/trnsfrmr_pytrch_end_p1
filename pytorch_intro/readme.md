...
__Here is what Actual Solution might be [NALU - Neural Arithmatic Logical Unit](https://blog.mlreview.com/simple-guide-to-neural-arithmetic-logic-units-nalu-explanation-intuition-and-code-64bc22605712)__

__Also should try with inputs as binary, that may work__
...
2. Cross Entropy for DigitRecognition & Random Sum - Weighted Sum, tried with different values (70-30), (90-10) weightages for digits and sums, this does NOT reduce loss significantly
